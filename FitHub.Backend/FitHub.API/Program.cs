...
public partial class Program
{
    private static async Task Main(string[] args)
    {
        ...
        try
        {
            Log.Information("Starting FitHub API...");
           ...
           builder.Services.AddPredictionEnginePool<FitnessPlanRating, FitnessPlanPrediction>()
            .FromFile(filePath: "FitnessRecommender.zip", watchForChanges: true);

            // Registracija PasswordHashera za Users entitet
            ...
            builder.Services.AddHttpClient<ExternalLoginCommandHandler>();
            builder.Services.AddHttpClient<SendMessageCommandHandler>();
            ...
            Log.Information("FitHub API started successfully.");
            app.Run();
        }
        catch (HostAbortedException)
        {
            // EF Core tools abort the host after they obtain DbContext.
        ...
        catch (Exception ex)
        {
            ...
            Log.Fatal(ex, "FitHub API terminated unexpectedly.");
        }
        finally
        {
